...
function handleClick(clickedButtonEvent) {
    ...
    const text = clickedButtonEvent.target.textContent;
...
function hideMoreText(card) {
    ...
    const desc = card.wrap.querySelector('.desc');
    if (desc) {
        desc.remove();
    }
...
function showMoreText(card) {
    ...
    const text = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia, possimus?'    

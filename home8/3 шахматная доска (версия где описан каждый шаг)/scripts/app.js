let app = {
    ...
    insertPawns() {
        ...
        // ошибка в описании: нужна 2-ая строка, а не 7-ая
        ...
        // ошибка в описании: нужна 7-ая строка, а не 2-ая
    ...
    generateBoard() {
        ...
        for (let i = 0; i < this.config.rows.length; i++) {
            ...
            // board += row;
            // переделал без лишних переменных и выражений
            board += this.generateRow(rowStartWithColor, this.config.rows[i]);
            rowStartWithColor = rowStartWithColor === 'white' ?
                'black' : 'white';
        }
    ...
    generateRow(startWithColor, rowNum) {
        ...
        for (let i = 0; i < this.config.cols.length; i++) {
            ...
            currentColorClass = currentColorClass === 'white' ?
                'black' : 'white';
        }
        return `<tr>${row}</tr>`;
    },
